...
fn test_rustls_server_with_ffdhe_kx(provider: CryptoProvider<'static>, iters: usize) {
...
fn ffdhe_provider() -> CryptoProvider<'static> {
    CryptoProvider {
...
fn server_config_with_ffdhe_kx(provider: CryptoProvider<'static>) -> ServerConfig {
