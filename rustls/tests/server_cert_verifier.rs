...
use rustls::client::{Client, WebPkiServerVerifier, verify_server_cert_signed_by_trust_anchor};
...
fn client_checks_server_certificate_with_given_ip_address() {
    fn check_server_name(
        ...
        let mut client = Connection::<Client>::new(client_config, server_name(name)).unwrap();
