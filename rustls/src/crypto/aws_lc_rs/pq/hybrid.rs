...
impl SupportedKxGroup for Hybrid {
    ...
    fn fips(&self) -> bool {
        ...
        // this and allow both orders.  But, for now, we follow that "logic".
        (self.layout.post_quantum_first && self.post_quantum.fips())
            || (!self.layout.post_quantum_first && self.classical.fips())
    }
