...
/// A kernel client connection.
///
/// The only difference for kernel client vs server connections is that client
/// connections have support for recording new session tickets.
pub type KernelClientConnection = KernelConnection<ClientConnectionData>;

/// A kernel server connection.
///
/// The only difference for kernel client vs server connections is that client
/// connections have support for recording new session tickets.
pub type KernelServerConnection = KernelConnection<ServerConnectionData>;
