...
use crate::common_state::{
    CommonState, DEFAULT_BUFFER_LIMIT, Output, State, UnborrowedPayload, process_main_protocol,
};
...
use crate::msgs::{
    BufferProgress, DeframerIter, DeframerVecBuffer, Delocator, Locator, Random, ReceivedData,
};
...
impl<Side: SideData> ConnectionCommon<Side> {
    ...
    pub fn read_tls(&mut self, rd: &mut dyn io::Read) -> Result<usize, io::Error> {
        ...
        let res = self.deframer_buffer.read(
            rd,
            self.core
                .side
                .recv
