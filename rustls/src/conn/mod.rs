...
impl<Side: SideData> VerifyPeerIdentity<Side> {
    ...
    pub fn presented_identity(&self) -> Result<Side::PeerIdentity<'static, '_>, Error> {
...
pub(crate) trait VerifyPeerIdentityInternal<Side: SideData>: Send + Sync {
    fn presented_identity(&self) -> Result<Side::PeerIdentity<'static, '_>, Error>;
