...
/// connection secrets and session tickets.
///
/// There are only two things that [`ExternalConnection`] is able to do:
...
/// [`UnbufferedClientConnection::dangerous_into_external_connection`][client-into]
/// and
/// [`UnbufferedServerConnection::dangerous_into_external_connection`][server-into].
///
/// In order to actually create an [`ExternalConnection`] all of the following
/// must be true:
...
///
/// [client-into]: crate::client::UnbufferedClientConnection::dangerous_into_external_connection
/// [server-into]: crate::server::UnbufferedServerConnection::dangerous_into_external_connection
...
///
/// [`ExternalConnection`] has no way to track this. It is the responsibility
...
/// [`ExternalConnection`]: crate::external::ExternalConnection
///
/// # Examples
/// The [`ktls-client`] example shows how to use [`ExternalConnection`] to drive
/// a kTLS connection.
///
