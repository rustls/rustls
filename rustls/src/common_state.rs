...
impl CommonState {
    ...
    fn send_msg_quic(&mut self, m: Message<'_>, must_encrypt: bool) {
    ...
    fn emit(&mut self, ev: Event<'_>) {
        match ev {
            ...
            Event::EncryptMessage(m) => match self.common.protocol {
                ...
                Protocol::Quic(_) => self.common.send_msg_quic(m, true),
            },
            ...
            Event::PlainMessage(m) => match self.common.protocol {
                ...
                Protocol::Quic(_) => self.common.send_msg_quic(m, false),
            },
