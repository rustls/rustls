...
use crate::msgs::handshake::{
    ClientHelloPayload, HandshakePayload, KeyExchangeAlgorithm, Random, ServerExtensions,
    ServerExtensionsTemplate, ServerNamePayload, SingleProtocolName,
};
...
impl ExtensionProcessing {
    pub(super) fn new(extra_exts: ServerExtensionsTemplate<'static>) -> Self {
        let ServerExtensionsTemplate {
...
pub(super) struct ExpectClientHello {
    ...
    pub(super) extra_exts: ServerExtensionsTemplate<'static>,
...
pub(super) fn process_client_hello<'m>(
    ...
    let sni: Option<DnsName<'_>> = match &client_hello.extensions.server_name {
