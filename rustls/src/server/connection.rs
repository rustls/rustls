...
impl Connection for ServerConnection {
    ...
    fn process_new_packets(&mut self, buf: &mut TlsInputBuffer) -> Result<crate::IoState, Error> {
...
impl Acceptor {
    ...
    pub fn accept(&mut self, buf: &mut TlsInputBuffer) -> Result<Option<Accepted>, (Error, AcceptedAlert)> {
