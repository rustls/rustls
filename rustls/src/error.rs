...
/// the wild.
// TODO: better names for the new errors?
pub enum PeerMisbehaved {
    ...
    IllegalEchExtensionInEchOuterExtensions,
    ...
    IncorrectBinder,
    InvalidEchExtensionInEchOuterAfterRetry,
    ...
    MismatchedEchOuterExtensions,
    MismatchedSniAndEchConfigPublicName,
    ...
    NonZeroClientHelloInnerPadding,
    ...
    OfferedIncorrectEchType,
    OfferedEchWithOldProtocolVersion,
