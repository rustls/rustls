...
fn refuses_server_ext_with_unparsed_bytes() {
    ...
    assert_eq!(
        ...
        InvalidMessage::TrailingData("ServerExtension")
    );
}
...
fn refuses_certificate_ext_with_unparsed_bytes() {
    ...
    assert_eq!(
        ...
        InvalidMessage::TrailingData("CertificateExtension")
    );
}
...
fn refuses_certificate_req_ext_with_unparsed_bytes() {
    ...
    assert_eq!(
        ...
        InvalidMessage::TrailingData("CertificateRequestExtension")
    );
}
...
fn refuses_new_session_ticket_ext_with_unparsed_bytes() {
    ...
    assert_eq!(
        ...
        InvalidMessage::TrailingData("NewSessionTicketExtension")
    );
}
