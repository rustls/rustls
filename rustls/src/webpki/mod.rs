...
pub(crate) use webpki::RawPublicKeyEntity;
...
pub use verify::{
    verify_tls12_signature, verify_tls12_signature_with_spki, verify_tls13_signature,
    verify_tls13_signature_with_spki, WebPkiSupportedAlgorithms,
};
