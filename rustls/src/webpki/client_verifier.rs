...
mod tests {
    ...
    fn test_client_verifier_required_auth() {
        ...
        let builder = WebPkiClientVerifier::builder(test_roots(), &provider::DEFAULT_PROVIDER);
    ...
    fn test_with_invalid_crls() {
        ...
        let result = WebPkiClientVerifier::builder(test_roots(), &provider::DEFAULT_PROVIDER)
